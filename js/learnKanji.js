...
for(var i = 0; i<kanjiData.length; i++){
    ...
    $('#cards').append("<div class='col s3 m3 l3'><div class='card'><div class='card-image'><img src='"+ kanjiData[i].image +"'></div><div class='card-content'><h5 class='teal-text text-darken-3'><b>"+ kanjiData[i].onyomi+"</b></h5><h6><b>KUNYOMI</b><br/>"+ kanjiData[i].kunyomi +"</h6><h6><b>MEANING</b><br/>"+ kanjiData[i].meaning +"</h6><h6><b>MNEMONIC</b><br/>"+ kanjiData[i].mnemonic +"</h6></div></div></div>");
    if(i % 4 == 3)
    {
    	$('#cards').append("</div>")
    }
